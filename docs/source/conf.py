...
html_context = {
    ...
    "github_repo": "deployfish", # Repo name
...
htmlhelp_basename = 'deployfishdoc'
...
latex_documents = [
    (master_doc, 'deployfish.tex', u'deployfish Documentation',
     u'Chris Malek, Glenn Bach', 'manual'),
]
...
man_pages = [
    (master_doc, 'deployfish', u'deployfish Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'deployfish', u'deployfish Documentation',
     author, 'deployfish', 'One line description of project.',
     'Miscellaneous'),
]
